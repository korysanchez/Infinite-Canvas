...
class _QueryDialog(Dialog):
    ...
    def __init__(self, title, prompt,
        ...
        self.prompt   = prompt
        if (kw):
            print(kw, kw.get('default'))
            SimpleDialog.__init__(self, parent, title=title, default=kw.get('default'))
        else:
            Dialog.__init__(self, parent, title, **kw)
    ...
    def done(self, num):
        ...
        print('sadfWWWWW')
        print(self.num)
        print('asdfasgaggggggggggoogly')
        print(self.result)
        return self.num


class _QueryChoices(_QueryDialog):
...
def askchoices(title, prompt, **kw):
    d = _QueryChoices(title, prompt, **kw)
    return d.result
